...
# Método para realizar el proceso de comparación
def identify_people(faces):
    ...
    # Declaramos la variable para almacenar el nombre de la persona identificada
    ...
    for face in faces:
        ...
        for i in data:
            ...
            if similarity > umbral:
                ...
                persona_identificada = i[1]
            
    print(persona_identificada)
